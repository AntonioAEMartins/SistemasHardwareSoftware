...
void main(){
    ...
    char string[100] = "www.google.com/antonio/google/tuzin/lincoln/enriccogemha";
    char *p =  &string[0];

    tamanho_string(string, p_string, p_arquivo, p_barra);
    ...
    extrai_string(string, p_string, p_arquivo, nova_string, p_barra);

    printf("Arquivo: %s", (nova_string));
}